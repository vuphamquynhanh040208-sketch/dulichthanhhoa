...
<body>
    ...
    <script>
        ...
        (https://github.com/vuphamquynhanh040208-sketch/texture.jpg.git)('3d-container', 'https://raw.githubusercontent.com/[tên-github-của-bạn]/du-lich-ao-thanh-hoa/main/texture.jpg'); // Thay bằng link ảnh

        // Khởi tạo 3D cho gem (có thể dùng ảnh khác)
        (https://github.com/vuphamquynhanh040208-sketch/texture.jpg.git)('gem-3d', 'https://raw.githubusercontent.com/[tên-github-của-bạn]/du-lich-ao-thanh-hoa/main/texture2.jpg');
    </script>
</body>
</html># dulichthanhhoa
